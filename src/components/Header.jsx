      ...
      >
        <div className=" flex items-center">
          ...
          <div className=" flex items-center gap-3 w-auto h-7">
            ...
            <p className=" font-bold text-slate-400 xs:hidden">Contacts</p>
      ...
      >
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li onClick={() => dispatch(addPath(""))} className={location?.pathname === '/create' ? 'bg-blue-500 text-slate-400 rounded-md' : ''}>
              <Link
                to={"/create"}
                data-drawer-hide="drawer-navigation"
                aria-controls="drawer-navigation"
            ...
            <li onClick={() => dispatch(addPath("contactList"))} className={location?.pathname === '/' ? 'bg-blue-500 text-slate-400 rounded-md' : ''}>
              <Link
                to={"/"}
                data-drawer-hide="drawer-navigation"
                aria-controls="drawer-navigation"
            ...
            <li className={location?.pathname === '/trash' ? 'bg-blue-600 text-slate-400 rounded-md' : ''}>
              <Link to={'/trash'}>
            ...
            <li onClick={()=>dispatch(addPath(""))} className={location?.pathname === '/login' ? 'bg-blue-500 text-slate-400 rounded-md' : ''}>
              <Link
                to={"/login"}
                data-drawer-hide="drawer-navigation"
                aria-controls="drawer-navigation"
            ...
            <li onClick={() => dispatch(addPath(""))} className={location?.pathname === '/register' ? 'bg-blue-500 text-slate-400 rounded-md' : ''}>
              <Link
                to={"/register"}
                data-drawer-hide="drawer-navigation"
                aria-controls="drawer-navigation"
